...
const SuitIcon = ({ suit, className = "" }: { suit: Suit, className?: string }) => {
    switch (suit) {
        ...
        case 'diamonds':
            return (
                <svg viewBox="0 0 16 16" className={className} fill="currentColor">
                    <path d="M2.45 7.4L7.2.7c.4-.6 1.2-.6 1.6 0l4.75 6.7c.4.6.4 1.4 0 2l-4.75 6.7c-.4.6-1.2.6-1.6 0L2.45 8.6c-.4-.6-.4-1.4 0-2z" />
                </svg>
            );
        case 'clubs':
            return (
        ...
        case 'spades':
            return (
                <svg viewBox="0 0 16 16" className={className} fill="currentColor">
                    <path d="M7.184 11.246A3.5 3.5 0 0 1 1 8c0-1.603 1.34-3.584 3.5-4.892C5.411 2.565 6.726 2 8 2s2.589.565 3.5 1.108C13.66 4.416 15 6.397 15 8a3.5 3.5 0 0 1-6.184 3.246l.71 1.755H6.474l.71-1.755z" />
                </svg>
            );
        default:
            return null;
